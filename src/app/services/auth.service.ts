...
import { RequestTokenInterface } from '../interfaces/request-token-interface';
...
export class AuthService {
  ...
  login(credentials : CredentialsInterface): Observable<TokenResponseInterface>{
    let data:RequestTokenInterface = {
      grant_type : "password",
